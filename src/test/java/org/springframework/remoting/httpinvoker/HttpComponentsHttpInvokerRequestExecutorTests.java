 ...
 */
class HttpComponentsHttpInvokerRequestExecutorTests {

  @Test
  void customizeConnectionRequestTimeout() throws IOException {
  ...
  @Test
  void customizeConnectionTimeout() throws IOException {
    HttpComponentsHttpInvokerRequestExecutor executor =
        new HttpComponentsHttpInvokerRequestExecutor();
  ...
  @Test
  void customizeReadTimeout() throws IOException {
    HttpComponentsHttpInvokerRequestExecutor executor =
        new HttpComponentsHttpInvokerRequestExecutor();
  ...
  @Test
  void defaultSettingsOfHttpClientMergedOnExecutorCustomization() throws IOException {
    ...
    HttpInvokerClientConfiguration config =
        mockHttpInvokerClientConfiguration("https://fake-service");
    HttpPost httpPost = executor.createHttpPost(config);
    assertThat(httpPost.getConfig()).as("Default client configuration is expected")
  ...
  @Test
  void ignoreFactorySettings() throws IOException {
